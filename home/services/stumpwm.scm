         ...
         (home-stumpwm-configuration
          ...
          (config
           (list
            ...
            #~"      ;; Keep long-running foreground/background jobs visible and"
            #~"      ;; alive: disable X11 screensaver blanking and DPMS power-off."
            #~"      (run-shell-command \"xset s off s noblank -dpms\")"
